...
void __fastcall TfrmBasics::btnCurvesClick(TObject* Sender)
{
...
void __fastcall TfrmBasics::btnEllipsesAndRectanglesClick(TObject* Sender)
{
...
void __fastcall TfrmBasics::btnHatchingClick(TObject* Sender)
{
...
void __fastcall TfrmBasics::btnTransformationsClick(TObject* Sender)
{
