...
public:
	...
	void __fastcall OnMouseDown(TObject* ASender, TMouseButton AButton, TShiftState AShift, float X, float Y);
	void __fastcall OnMouseLeave(TObject* ASender);
	void __fastcall OnMouseMove(TObject* ASender, TShiftState AShift, float X, float Y);
	void __fastcall OnMouseUp(TObject* ASender, TMouseButton AButton, TShiftState AShift, float X, float Y);
};

static std::unique_ptr<TFreehandRender> FFreehandRender;

void __fastcall TfrmTSkPaintBox::btnFreehandClick(TObject* Sender)
{
...
void __fastcall TfrmTSkPaintBox::btnSweepGradientClick(TObject* Sender)
{
...
void __fastcall TFreehandRender::OnMouseDown(TObject* ASender,
	TMouseButton AButton, TShiftState AShift, float X, float Y)
{
	FPressed = true;
...
void __fastcall TFreehandRender::OnMouseMove(TObject* ASender,
	TShiftState AShift, float X, float Y)
{
