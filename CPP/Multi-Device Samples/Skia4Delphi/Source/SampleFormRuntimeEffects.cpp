...
void __fastcall TfrmRuntimeEffects::btnStarNestShaderAnimationClick(TObject* Sender)
{
...
void __fastcall TfrmRuntimeEffects::btnTimeVaryingShaderClick(TObject* Sender)
{
