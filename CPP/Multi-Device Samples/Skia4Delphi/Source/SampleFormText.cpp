...
void __fastcall TfrmText::btnBasicTextsClick(TObject* Sender)
{
...
void __fastcall TfrmText::btnCustomFontClick(TObject* Sender)
{
	ChildForm<TfrmPaintBoxViewer>()->Show("Basic Texts", "",
		[this](ISkCanvas* const ACanvas, const TRectF& ADest) {
			auto LPaint = SkPaint();
...
void __fastcall TfrmText::btnParagraphClick(TObject* Sender)
{
...
void __fastcall TfrmText::btnParagraphToPathClick(TObject* Sender)
{
...
void __fastcall TfrmText::btnRTLClick(TObject* Sender)
{
...
void __fastcall TfrmText::btnTSkLabelClick(TObject* Sender)
{
