...
private:	// User declarations
	TGeocoder * FGeocoder;
	String FPermissionAccessCoarseLocation;
	String FPermissionAccessFineLocation;
	...
	void __fastcall PermissionRequestResult(TObject *Sender, const TClassicStringDynArray APermissions, const TClassicPermissionStatusDynArray AGrantResults);
#endif
