  ...
  object pc_Demos: TPageControl
    ...
    object ts_GoogleTasks: TTabSheet
      ...
      object btn_GoogleTasks_FetchAuthToken: TButton
        ...
        Width = 273
        Height = 49
        Caption = 'Step #1 authenticate and get tokens'
        TabOrder = 1
    ...
    object ts_Facebook: TTabSheet
      ...
      object btn_Facebook_FetchAuthToken: TButton
        ...
        Width = 273
        Height = 49
        Caption = 'Step #1 authenticate and get token'
        TabOrder = 2
      ...
      object edt_Facebook_ResourceURI: TLabeledEdit
        ...
        TabOrder = 7
        Text = 
          '100084465255790?fields=name,birthday,friends.limit(10).fields(na' +
          'me)'
      end
    end
    ...
    object tc_OpenMeteo: TTabSheet
      ...
      object edt_openmeteo_latitude: TLabeledEdit
        Left = 241
        Top = 123
        Width = 376
        Height = 21
      ...
      object edt_openmeteo_url: TLabeledEdit
        Left = 241
        Top = 35
        Width = 376
        Height = 21
        EditLabel.Width = 112
        EditLabel.Height = 13
        EditLabel.Caption = 'Open-Meteo Base URL:'
        TabOrder = 1
        Text = 'https://api.open-meteo.com/v1/'
      end
      object edt_openmeteo_resource: TLabeledEdit
        Left = 241
        Top = 80
        Width = 376
        Height = 21
        ...
        EditLabel.Caption = 'Resource-URI:'
        TabOrder = 2
        Text = 'forecast?latitude={LAT}&longitude={LONG}&current_weather=true'
      end
      object ButtonOpenMeteo: TButton
        Left = 241
        Top = 190
        Width = 273
        Height = 49
      ...
      object Memo1: TMemo
        ...
        Color = clInfoBk
        Lines.Strings = (
          'this demo connects to a Open-Meteo'
          'service. And fetches current '
          'temperature of a place with'
          'specified latitude and longitude.')
        ReadOnly = True
        ScrollBars = ssVertical
        TabOrder = 4
      end
      object edt_openmeteo_longitude: TLabeledEdit
        Left = 241
        Top = 163
        Width = 376
        Height = 21
    ...
    object ts_DropBox: TTabSheet
      ...
      object edt_DropBox_BaseURL: TLabeledEdit
        ...
        EditLabel.Caption = 'Base-URL:'
        TabOrder = 3
        Text = 'https://api.dropboxapi.com/2/'
      end
